...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { user, profile, isAuthenticated, logout, loginWithGoogle } = useAuth();
          ...
          {isAuthenticated ? (
            ...
            <>
              <button
                ...
                className="px-3 py-2 text-xs font-semibold bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-amber-500/40 rounded-xl transition-all flex items-center gap-2 whitespace-nowrap shadow-sm"
